...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 active:animate-button-press",
        destructive:
        ...
        ghost: "hover:bg-accent hover:text-accent-foreground hover:scale-105 active:animate-button-press",
        link: "text-primary underline-offset-4 hover:underline hover:scale-105",
        premium: "bg-gradient-button text-accent-foreground hover:bg-gradient-hover hover:scale-105 hover:shadow-lg hover:shadow-accent/25 active:animate-button-press transition-all duration-300 relative group overflow-hidden before:absolute before:inset-0 before:bg-gradient-hover before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300",
        glow: "bg-accent text-accent-foreground hover:bg-accent/90 hover:scale-105 active:animate-button-press animate-button-glow",
      },
      size: {
