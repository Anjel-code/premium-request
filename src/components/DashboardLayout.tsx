...
export function DashboardLayout({ children, userRole = 'user' }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen flex w-full bg-background">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'w-60' : 'w-14'} transition-all duration-300 bg-card border-r flex flex-col`}>
        <div className="p-4">
          <Button
            variant="ghost"
            size="icon"
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="h-16 border-b bg-card px-6 flex items-center justify-between">
          <h1 className="text-xl font-semibold text-primary">The Product Concierge</h1>
